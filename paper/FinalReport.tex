...
\begin{figure}[!h]
  ...
  \begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width = 9.5cm]{tetris.png}
    \caption{Basic tetris-like patterns}
    \label{fig::tetris}
  \end{subfigure}
  \begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width = 9.5cm]{tetrisfeature.png}
    \caption{Features extracted from the data}
    \label{fig::tetrisfeature}
  \end{subfigure}
  \begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width = 9.5cm]{tetrisdetection.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width = \textwidth]{gibbsresultblock.png}
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[b]{0.35\textwidth}
    \centering
    \includegraphics[width = 2.75cm]{sample_original.png}
    \caption{Original image}
  \end{subfigure} 
  \begin{subfigure}[b]{0.35\textwidth}
    \centering
    \includegraphics[width = 2.3cm]{sample_cropped.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width = \textwidth]{gibbsresult.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width = \textwidth]{featuremap.png} 
